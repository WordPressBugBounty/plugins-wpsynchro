...
{
    public MigrationFactory $migration_factory;
    ...
    private function handleGET()
    {
        ...
        // Check if onboarding help should be shown
        $show_onboarding_help = $plugin_configuration->getShowOnboarding();
        if (isset($_GET['onboarding_help']) && $_GET['onboarding_help'] == 0) {
            $plugin_configuration->setShowOnboarding(false);
            $show_onboarding_help = false;
        }
        ...
        $data_for_js = [
            ...
            "showOnboardingHelp" => $show_onboarding_help,
        ...
        // Print content
        echo '<div id="wpsynchro-migrations" class="wpsynchro"></div>';
    }
}
